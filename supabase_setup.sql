...
CREATE POLICY "允許匿名用戶插入資料" ON public.users
  FOR INSERT TO anon WITH CHECK (true);

CREATE POLICY "允許已認證用戶插入資料" ON public.users
...
CREATE POLICY "允許匿名用戶插入 OAuth 帳戶" ON public.oauth_accounts
  FOR INSERT TO anon WITH CHECK (true);

CREATE POLICY "允許已認證用戶插入 OAuth 帳戶" ON public.oauth_accounts
  FOR INSERT TO authenticated WITH CHECK (true);
